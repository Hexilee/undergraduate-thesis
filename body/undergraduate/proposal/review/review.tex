...
MEMS传感器基于微机电系统。它们各自的优缺点和应用场景对比如表~\ref{review:table:css}所示。

\begin{table}[h]\footnotesize
\caption{三种接触式CSS对比}
\label{review:table:css}
\begin{center}
...
FOS的发展趋势如表\ref{review:table:foss}：

\begin{table}\footnotesize
\caption{FOSS的发展趋势\cite{recent-dev-in-foss}}
\label{review:table:foss}
\begin{center}
\tabcolsep=0.10cm
