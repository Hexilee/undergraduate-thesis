...
%-----------------------
\coordinate (O) at (0,0,0) node[anchor=south east]{$o_0$};
...
\tdplotsetcoord{O1}{\rvec}{\thetavec}{\alphavec};
\node[label={above:$o_1$}] at (O1) {};

\tdplotsetcoord{P}{.8}{90}{60};
\node[label={above:$p_0$}] at (P) {};
...
\draw[dashed, color=red] (O) -- (O1xy);
\draw[dashed, color=red] (O1) -- (O1xy);

%draw the angle \alpha, and label it
%syntax: \tdplotdrawarc[coordinate frame, draw options]{center point}{r}{angle}{label options}{label}
\tdplotdrawarc{(O)}{0.2}{0}{\alphavec}{anchor=north}{$\alpha$}
...
\tdplotsetrotatedcoords{\alphavec}{\thetavec}{0}
